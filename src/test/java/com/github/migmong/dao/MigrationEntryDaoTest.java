...
import com.github.migmong.AbstractMigrationTest;
import com.github.migmong.common.Constants;
...
public class MigrationEntryDaoTest extends AbstractMigrationTest
{
    ...
    public void shouldCheckLockHeldFromFromLockDao() throws Exception
    {
        ...
        ChangeEntryDao dao = new ChangeEntryDao(Constants.TEST_MIGRATION_COLLECTION, Constants.TEST_LOCK_COLLECTION, WAIT_FOR_LOCK,
        ...
        dao.connectMongoDb(mongoClient, Constants.TEST_DB_NAME);
    ...
    public void shouldNotCreateChangeIdAuthorIndexIfFound() throws MigrationConfigurationException
    {
        ...
        verify(indexDaoMock, times(0)).createRequiredUniqueIndex(db.getCollection(Constants.TEST_MIGRATION_COLLECTION));
        verify(indexDaoMock, times(0)).dropIndex(db.getCollection(Constants.TEST_MIGRATION_COLLECTION), new Document());
    }
    ...
    public void shouldWaitForLockIfWaitForLockIsTrue() throws Exception
    {
        ...
        ChangeEntryDao dao = new ChangeEntryDao(Constants.TEST_MIGRATION_COLLECTION, Constants.TEST_LOCK_COLLECTION, true,
                CHANGE_LOG_LOCK_WAIT_TIME, CHANGE_LOG_LOCK_POLL_RATE, THROW_EXCEPTION_IF_CANNOT_OBTAIN_LOCK);
